<template>
  <div id="articleContent" class="ajaxed-in">
    ...
    <p>
      ...
      choosing the right learning mode for your learning product.
    </p>
    Download the
    <a
    ...
    >Framework</a>
    <p class="text-center">
      <img alt="example of the Content Curation List." class="text-center" src="~/assets/instructional_design/learning_mode_decision_making_framework.png">
    </p>
  </div>
