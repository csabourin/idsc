<template>
  <div id="articleContent" class="ajaxed-in">
    ...
    <p>
      Download the <a
        href="http://gcdocs.csps-efpc.gc.ca/otcs/llisapi.dll?func=ll&amp;objId=6002951&amp;objAction=download"
        target="_blank"
      >Learner Identification Analysis</a>.
    </p>
    <p class="text-center">
      <img
        alt="example of Learner Identification Analysis"
        src="~/assets/instructional_design/learner-identification-analysis-en.png"
      >
    </p>
  </div>
