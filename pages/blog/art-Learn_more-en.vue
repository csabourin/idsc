<template>
  <div id="articleContent" class="ajaxed-in">
    <h2>Blogs: Learn more</h2>

    <p>
      If you would like to learn more about blogs and blogging, the following books can be requested from the CSPS
      Library. You may reserve these items by clicking on the links provided.
    </p>
    ...
    <ul class="fa-ul">
      <li>
        ...
        >Social media for trainers: techniques for enhancing and extending learning</a></em>. <span>San
          Francisco: Pfeiffer.</span> (essential resources for training and HR professionals).<br>
        ISBN 9780470631065
      </li>
      ...
      <li>
        <span class="glyphicon glyphicon-book fa-li" /> <span>Jue, Arthur L., Jackie Alcalde Marr, and Mary
          ...
          target="_blank"
        >Social media at work: how networking tools propel organizational performance</a></em><span>.
          San Francisco, CA: Jossey-Bass.</span><br>
        ISBN 9780470405437
      </li>
    ...
    <p>
      Below is a list of recommended ebooks available from the CSPS eLibrary. Click on a link to view the ebook from
      your browser or to download them to your computer or tablet for a one-week period. To download to your tablet or
      smartphone, you will need the Bluefire Reader application .
    </p>
