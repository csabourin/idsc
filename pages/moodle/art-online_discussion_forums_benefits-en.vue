<template>
  <div id="articleContent" class="ajaxed-in">
    ...
    <ul>
      <li>Builds class cohesiveness by promoting  discussion on course topics.</li>
      <li>Students can participate asynchronously  when it is most convenient for them.</li>
      <li>Allows time for in-depth reflection; students  have more time to reflect, do research and compose their thoughts before  participating in the discussion.</li>
      <li>Facilitates learning by allowing  students to view posts and learn from others in the program.</li>
      <li>Students are able to respond and  participate at their level of comfort. </li>
      <li>Allows guest experts to participate by  posting information and responding to course discussion posts.</li>
    </ul>
  </div>
</template>
