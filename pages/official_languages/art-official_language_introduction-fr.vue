<template>
  <div id="articleContent" class="ajaxed-in">
    ...
    <ul id="ecosystemTxt">
      <ul id="ecosystemTxt">
        <li>
          <p>Événements. ateliers, webdiffusions, webinaires</p>
        </li>
        <li>
        ...
        <li>
          <p>Apprentissage mobile sans fil</p>
        </li>
        <li>
          <p class="text-right">
            Apprentissage de masse / social <br>
            <small><em>(blogues, forums, contenu libre)</em></small>
          </p>
        </li>
        <li>
          <p>Soutien au rendement / Outils de travail</p>
        </li>
      </ul>
    </ul>
