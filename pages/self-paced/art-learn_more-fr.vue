<template>
  <div id="articleContent" class="ajaxed-in">
    <h2>Cours adapte au rythme de l’apprenant: Pour en apprendre davantage</h2>
    <h3>Livres de bibliothèque</h3>
    <p>
      Si vous aimeriez en apprendre davantage sur le thème des blogues, les
      livres sont disponibles à la bibliothèque de l’EFPC. Vous pouvez faire une
      réservation en cliquant sur les liens vers le catalogue ci-dessous.
    </p>
    <ul class="fa-ul">
      <li>
    ...
    <p>
      Voici une liste des livres numériques recommandées, disponibles à partir
      de la cyber-bibliothèque de l’EFPC. Cliquez sur un lien pour consulter le
      livre numérique à partir de votre navigateur ou pour le télécharger sur
      votre ordinateur ou sur votre tablette pour une période d'une semaine.
      Veuillez noter que vous aurez besoin de l'application Bluefire Reader afin
      de télécharger sur votre tablette ou téléphone intelligent.
    </p>
    <ul class="fa-ul">
      <li>
        <span class="fa fa-book fa-li" /> Gauthier, C., Jobin, V. <a href="//search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=265652&site=ehost-live" target="_blank"><strong><em>Moins c'est souvent mieux : Guide des principes
          ...
          psychologie cognitive.</em></strong></a> Presses de l'Université Laval):
        2009.
      </li>
      <li>
        <span class="fa fa-book fa-li" /> Clark, R. <a href="//search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=513955&site=ehost-live" target="_blank"><strong><em>Scenario-based Learning: evidence-based
          Guidelines for Online Workforce e-learning.</em></strong></a> John Wiley &
        Sons, Inc: 2013.
      </li>
      <li>
        <span class="fa fa-book fa-li" /> DiMarco, G., Luzzatto, e. <a href="//search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=369968&site=ehost-live" target="_blank"><strong><em>Collaborative Learning : Methodology, Types of Interactions
          and Techniques.</em></strong></a> Nova Science Publishers: 2010.
      </li>
      <li>
      ...
      <li>
        <span class="fa fa-book fa-li" /> Phillips, R. <a href="//search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=778563&site=ehost-live" target="_blank"><strong><em>The
          Developer's Handbook of Interactive Multimedia.</em></strong></a> Taylor &
        Francis Ltd (Routledge): 2013.
      </li>
      <li>
        <span class="fa fa-book fa-li" /> Sekhon, M., Hartley, D. e. <a href="//search.ebscohost.com/login.aspx?direct=true&db=nlebk&AN=802230&site=ehost-live" target="_blank"><strong><em>Basics of e-learning Revisited.</em></strong></a> Association
        for Talent Development (American Society for Training & Development),
        2014.
      </li>
    </ul>
    <h3>Ressources en ligne</h3>
    <p>
      Si vous souhaitez savoir plus sur la salle de classe virtuelle, les
      ressources en ligne suivantes sont recommandées.
    </p>
    <ul class="fa-ul">
      <li>
        <a href="http://www.fao.org/docrep/015/i2516f/i2516f00.htm" target="_blank">Méthodologies
          pour le développement de cours e-learning : Un guide pour concevoir
          et élaborer des cours d’apprentissage numérique</a>
      </li>
      <li>
        <a href="//www.technocompetences.qc.ca/sites/default/files/uploads/industrie/etudes-et-rapports/2003/e-Learning_guide.pdf" target="_blank">Guide pratique de l’apprentissage virtuel en entreprise.</a> (Techno
        Compétences)
      </li>
      <li> <a href="//ellicom.com/blogue/?lang=fr" target="_blank">Blogue</a> (ellicom ) </li>
      <li>
        <a href="http://www.fao.org/docrep/015/i2516e/i2516e00.htm" target="_blank">e-learning
          methodologies: A guide for designing and developing e-learning
          courses</a>
      </li>
      <li>
        <a href="http://www.td.org/About" target="_blank">Association of Talent
          Development</a> (ASTD)
      </li>
      <li>
        <a href="//theelearningcoach.com/" target="_blank">Designing Smarter Learning
          experiences</a> (The eLearning coach)
      </li>
      <li>
        <a href="http://www.learningsolutionsmag.com/" target="_blank">Learning strategies,
          tips and articles</a> (The Learning Solutions Magazine)
      </li>
      <li> <a href="//elearningfeeds.com/" target="_blank">e-learning News Feeds</a> (eLearning feeds.com ) </li>
      <li>
        <a href="http://www.commlabindia.com/" target="_blank">CommLab India for effective
          Learning</a> (Comm Lab India)
      </li>
      <li> <a href="//elearningindustry.com/" target="_blank">e-learning Industry</a> </li>
      <li> <a href="//elearninguncovered.com/" target="_blank">e-learning Uncovered</a> </li>
      <li> <a href="//elearningtags.com/" target="_blank">e-learning Tags</a> </li>
      <li>
        <a href="//community.articulate.com/" target="_blank">e-learning Heroes</a> (
        Articulate Community)
      </li>
      <li> <a href="http://www.quinnovation.com/" target="_blank">Quinnovation</a> </li>
      <li>
        <a href="http://www.kineo.com/resources/papers-and-guides/" target="_blank">City
          and Guilds Kineo e-learning Reports</a> (Kineo)
      </li>
      <li>
        <a href="http://www.e-learningcentre.co.uk/" target="_blank">e-learning Centre:
          engaging effective e-learning by Learning Light</a> (e-learning
        Centre)
      </li>
      <li>
        <a href="http://www.elearninglearning.com/" target="_blank">e-learning Learning
          by The Training Magazine Network</a> (e-learning learning)
      </li>
      <li>
        <a href="http://www.flexiblelearning.net.au/" target="_blank">National Vet
          e-learning Strategy</a> (Flexible Learning)
      </li>
    </ul>
  </div>
</template>
